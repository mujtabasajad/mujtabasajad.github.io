...
So for the next 100 days I am going to spend every learning something new about this. I want to be able to understand the fundamentals of GPU computing all the way up to LLM inference.

## What I will be learning 
I will be working through a lot of stuff and will hopefully cover:
     - CUDA programming
     - GPU Profiling
     - Kernel Optimisation
     - KV Caching
...
I do not have a clue how I will cover it each day but I will start by working through the Inference Engineering book and see what happens from there.
